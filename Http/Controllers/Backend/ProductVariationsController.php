...
class ProductVariationsController extends Controller
{
    ...
    {
        try{
            return ProductVariation::fillItem($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    public function sendMailForStock(Request $request)
    {
        try{
            return ProductVariation::sendMailForStock($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return ProductVariation::setProductInFilter($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
