...
class CustomerGroupsController extends Controller
{
    ...
    {
        try{
            return CustomerGroup::getList($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    public function listAction(Request $request, $type)
    {
        ...
        try{
            return CustomerGroup::listAction($request, $type);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    {
        try{
            return CustomerGroup::getItem($id);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
    ...
    public function getCustomersBySlug(Request $request)
    {
        try{
            return CustomerGroup::getCustomersBySlug($request);
        }catch (\Exception $e){
            $response = [];
