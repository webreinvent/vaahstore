        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <b-field label="Name" :label-position="data.form.label_position">
                    <b-input name="brands-name"
                             data-wdio="brands-name"
                             v-model="data.item.name"></b-input>
                </b-field>

                <b-field label="Slug" :label-position="data.form.label_position">
                    <b-input name="brands-slug"
                             data-wdio="brands-slug"
                             v-model="data.item.slug">
                    </b-input>
                </b-field>

                <b-field label="Registered By" :label-position="data.form.label_position">
                    <auto-complete-users @onSelect="setRegisteredBy"></auto-complete-users>
                </b-field>
                ...
                <b-field label="Status Notes"
                         message="These notes will be visible to the user who registered it."
