        ...
        <div :class="{'flex justify-content-between': store.isViewLarge()}">
            ...
            <div v-if="store.view === 'large'">
                ...
                <Button
                    ...
                    data-testid="productmedias-actions-menu"
                    aria-haspopup="true"
                ...
                <Button
                    ...
                    data-testid="productmedias-actions-bulk-menu"
                    aria-haspopup="true"
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="productmedias-actions-search"
                                       placeholder="Search"/>
                            <Button @click="store.delayedSearch()"
                                    data-testid="productmedias-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                type="button"
                                class="p-button-sm"
                                data-testid="productmedias-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="productmedias-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
