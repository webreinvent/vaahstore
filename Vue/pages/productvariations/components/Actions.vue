        ...
        <div :class="{'flex justify-content-between': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="productvariations-actions-menu"
                    aria-haspopup="true"
                ...
                <Button
                    ...
                    data-testid="productvariations-actions-bulk-menu"
                    aria-haspopup="true"
...
<!--            <div>-->
                <div class="flex gap-1">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="productvariations-actions-search"
                                       placeholder="Search"/>
                                </div>
                            ...
                            >Reset <Icon icon="mingcute:filter-line" width="14" height="14" style="color: #7b7a7a" /></Button>
