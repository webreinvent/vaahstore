            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    <Button label="Edit"
                            ...
                            data-testid="attributegroups-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        :disabled="!store.assets.permissions.includes('can-update-module')"
                        data-testid="attributegroups-item-menu"
                    ...
                    <Button class="p-button-primary p-button-sm"
                            icon="pi pi-times"
                            data-testid="attributegroups-item-to-list"
                            @click="store.toList()"/>
            ...
            <div class="mt-2" v-if="store.item">
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="attributegroups-item-restore"
                ...
                <table class="p-datatable-table">
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        <template v-if="column === 'created_by' || column === 'updated_by' || column === 'meta'|| column === 'deleted_by' || column === 'attributes_list' || column === 'description'|| column === 'active_attributes'">
                        </template>
