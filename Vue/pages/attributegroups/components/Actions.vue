        ...
        <div :class="{'flex justify-content-between': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="attributegroups-actions-menu"
                    aria-haspopup="true"
                ...
                <Button
                    ...
                    data-testid="attributegroups-actions-bulk-menu"
                    aria-haspopup="true"
                ...
                <div class="grid p-fluid">
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <Button
                                as="router-link"
                                :to="`/attributesgroup/filters`"
                                type="button"
                                size="small"
                                data-testid="attributegroups-actions-show-filters"
                            >
