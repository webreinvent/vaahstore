            ...
            <div class="mt-2" v-if="store.item">
                ...
                <Tabs value="0">
                    ...
                    <TabList>
                        ...
                        <Tab value="1">Transaction History ({{ store.item?.payments?.length || 0 }})</Tab>
                                 ...
                                 || column === 'deleted_by_user') && (typeof value === 'object' && value !== null)">
                                        ...
                                        <template v-else-if="column === 'order_status'">
                                            ...
                                            <tr>
                                                ...
                                                <td  colspan="2" >
                                                    <Badge class="word-overflow" :severity="store.item.order_shipment_status === 'Delivered' ? 'success' : 'warn'">
