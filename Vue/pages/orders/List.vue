...
<template>
  <div class="w-full bg-gray-100" v-if="store.assets">
          ...
          <template #header>
            <div class="flex items-center gap-2">
              <Icon
                ...
                class="text-gray-950"
              ></Icon>
              <p class="text-gray-950 font-normal text-base leading-5">
                Orders
              </p>
                ...
                <Card>
                  <template #title>
                    <div class="flex gap-1 items-center">
                      ...
                      <span class="text-xs">
                       <span v-html="store.default_currency_symbol"></span>
                                  {{
                                    store.overall_sales > 0
                                      ? parseFloat(store.overall_sales)
                                          .toFixed(2)
                                          .replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                                      : "0.00"
                                  }}
