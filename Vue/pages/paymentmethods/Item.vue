            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    <Button label="Edit"
                            ...
                            data-testid="paymentmethods-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        data-testid="paymentmethods-item-menu"
                    ...
                    <Button class="p-button-primary"
                            icon="pi pi-times"
                            data-testid="paymentmethods-item-to-list"
                            @click="store.toList()"/>
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="paymentmethods-item-restore"
