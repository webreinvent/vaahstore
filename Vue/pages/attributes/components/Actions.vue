        ...
        <div :class="{'flex justify-content-between': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="attributes-actions-menu"
                    aria-haspopup="true"
                ...
                <Button
                    ...
                    data-testid="attributes-actions-bulk-menu"
                    aria-haspopup="true"
            ...
            <div>
                <div class="flex gap-1">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="attributes-actions-search"
                                       placeholder="Search"/>
                                </div>
                            <Button @click="store.delayedSearch()"
                                    class="p-button-sm"
                                    data-testid="attributes-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                v-if="!store.isMobile"
                                as="router-link"
                                :to="`/attributes/filters`"
                                type="button"
                                size="small"
                                data-testid="attributes-actions-show-filters"
                            ...
                            <Button
                                type="button"
                                data-testid="attributes-actions-reset-filters"
                                class="p-button-sm"
                                @click="store.resetQuery()" >Reset
                                <Icon icon="mingcute:filter-line" width="14" height="14" style="color: #7b7a7a" />
                            </Button>
                </div>
            </div>
