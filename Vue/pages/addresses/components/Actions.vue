        ...
        <div :class="{'flex justify-content-between': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="addresses-actions-menu"
                    aria-haspopup="true"
                ...
                <Button
                    ...
                    data-testid="addresses-actions-bulk-menu"
                    aria-haspopup="true"
            ...
            <div>
                <InputGroup>
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="addresses-actions-search"
                                       placeholder="Search"/>
                            <Button @click="store.delayedSearch()"
                                    class="p-button-sm"
                                    data-testid="addresses-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                v-if="!store.isMobile"
                                as="router-link"
                                :to="`/addresses/filters`"
                                type="button"
                                size="small"
                                data-testid="addresses-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="addresses-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
