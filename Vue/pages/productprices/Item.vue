            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    <Button label="Edit"
                            ...
                            data-testid="productprices-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        data-testid="productprices-item-menu"
                    ...
                    <Button class="p-button-primary"
                            icon="pi pi-times"
                            data-testid="productprices-item-to-list"
                            @click="store.toList()"/>
            ...
            <div v-if="store.item">
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="productprices-item-restore"
                ...
                <table class="p-datatable-table">
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        column === 'vendor' || column === 'product' || column === 'updated_by'">
                        </template>
