            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    ...
                    <Button label="Edit"
                            ...
                            data-testid="categories-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        data-testid="categories-item-menu"
                    ...
                    <Button class="p-button-primary p-button-sm"
                            icon="pi pi-times"
                            data-testid="categories-item-to-list"
                            @click="store.toList()"/>
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="categories-item-restore"
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        <template v-else-if="column === 'parent_category_id'">
                            ...
                            <tr v-if="store.item.parent_category">
                                ...
                                <td  colspan="2" >
                                    <span >
                                        {{store.item.parent_category_name}}
                                    </span>
                                </td>
                            </tr>
                        </template>
