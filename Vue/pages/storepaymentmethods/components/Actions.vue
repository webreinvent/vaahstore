        ...
        <div :class="{'flex justify-content-between': store.isListView()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'list'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="storepaymentmethods-actions-menu"
                    aria-haspopup="true"
                ...
                <Button
                    ...
                    data-testid="storepaymentmethods-actions-bulk-menu"
                    aria-haspopup="true"
            ...
            <div>
                <InputGroup>
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="storepaymentmethods-actions-search"
                                       placeholder="Search"/>
                            <Button @click="store.delayedSearch()"
                                    class="p-button-sm"
                                    data-testid="storepaymentmethods-actions-search-button"
                                    icon="pi pi-search"/>
                            <Button
                                v-if="!store.isMobile"
                                as="router-link"
                                :to="`/storepaymentmethods/filters`"
                                type="button"
                                size="small"
                                data-testid="storepaymentmethods-actions-show-filters"
                            ...
                            <Button
                                ...
                                data-testid="storepaymentmethods-actions-reset-filters"
                                class="p-button-sm"
                                label="Reset"
