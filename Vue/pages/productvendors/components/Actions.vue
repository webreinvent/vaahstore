        ...
        <div :class="{'flex justify-content-between': store.isViewLarge()}" class="mt-2 mb-2">
            ...
            <div v-if="store.view === 'large'">
                ...
                <Button class="p-button-sm"
                    ...
                    data-testid="productvendors-actions-menu"
                    aria-haspopup="true" :disabled="!store.assets.permissions.includes('can-update-module')"
                ...
                <Button
                    ...
                    data-testid="productvendors-actions-bulk-menu"
                    aria-haspopup="true"
                    ...
                    <div class="col-12">
                        <div class="p-inputgroup ">
                            ...
                            <InputText v-model="store.query.filter.q"
                                       ...
                                       data-testid="productvendors-actions-search"
                                       placeholder="Search"/>
