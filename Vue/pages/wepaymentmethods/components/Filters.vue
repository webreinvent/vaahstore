...
import { useWePaymentMehthodStore } from '../../../stores/store-wepaymentmethods'
import VhFieldVertical from './../../../vaahvue/vue-three/primeflex/VhFieldVertical.vue'

const store = useWePaymentMehthodStore();
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-none"
                                 inputId="sort-none"
                                 data-testid="wepaymentmethods-filters-sort-none"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-ascending"
                                 ...
                                 data-testid="wepaymentmethods-filters-sort-ascending"
                                 value="updated_at"
                                 v-model="store.query.filter.sort" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-descending"
                                 ...
                                 data-testid="wepaymentmethods-filters-sort-descending"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-all"
                                 inputId="active-all"
                                 value="null"
                                 data-testid="wepaymentmethods-filters-active-all"
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-true"
                                 inputId="active-true"
                                 data-testid="wepaymentmethods-filters-active-true"
                                 value="true"
                                 v-model="store.query.filter.is_active" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-false"
                                 ...
                                 data-testid="wepaymentmethods-filters-active-false"
                                 value="false"
                                 v-model="store.query.filter.is_active" />
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-exclude"
                                 ...
                                 data-testid="wepaymentmethods-filters-trashed-exclude"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-include"
                                 ...
                                 data-testid="wepaymentmethods-filters-trashed-include"
                                 value="include"
                                 v-model="store.query.filter.trashed" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-only"
                                 ...
                                 data-testid="wepaymentmethods-filters-trashed-only"
                                 value="only"
                                 v-model="store.query.filter.trashed" />
